var store = [{
        "title": "Hello",
        "excerpt":"Hello   World   你好   世界  ","categories": ["Random"],
        "tags": ["Random"],
        "url": "/random/2020/06/21/hello.html",
        "teaser": null
      },{
        ...
        "excerpt":"本文的中文版 Although there are often complaints saying Rust’compilation speed is notorious slow, our project RisingWave is not very slow to compile, especially since previously contributors like (skyzh, BugenZhao) have put in a lot of effort. After using an M1 MacBook Pro, compiling is not a problem at all. A full...","categories": ["CS"],
        "tags": [],
        "url": "/cs/2023/02/17/optimize-rust-comptime-en.html",
        "teaser": null
      },{
        "title": "This Week in RisingWave #1 (20230217)",
        "excerpt":"RisingWave is a distributed SQL database for stream processing written in Rust. As a developer of RisingWave, I’m always excited (and also a little bit overwhelmed) about its progress every day. So why not share the excitement with more people (and also help myself to get a better understanding)? That’s...","categories": ["This-Week-in-RisingWave"],
        "tags": [],
        "url": "/this-week-in-risingwave/2023/02/17/twirw-1.html",
        "teaser": null
      },{
        "title": "This Week in RisingWave #2 (20230225)",
        "excerpt":"See #1 for an introduction of this series. This blog series is my personal comments about (part of) the development of RisingWave. Please take it as an unofficial and no-promise supplement. Most exciting things 🤩 Common sub-plan sharing We decided to refactor tree-structured plan node into a DAG some time...","categories": ["This-Week-in-RisingWave"],
        "tags": [],
        "url": "/this-week-in-risingwave/2023/02/25/twirw-2.html",
        "teaser": null
      },{
        "title": "This Week in RisingWave #3 (20230304)",
        "excerpt":"This blog series is my personal comments about (part of) the development of RisingWave. Please take it as an unofficial and no-promise supplement. Notable changes Memory control policy feat(memory): introduce memory control policy for computing tasks by xx01cyx #7767 Tracking: refactor user-configurable memory control policy #8228 refactor: introduce memory control...","categories": ["This-Week-in-RisingWave"],
        "tags": [],
        "url": "/this-week-in-risingwave/2023/03/04/twirw-3.html",
        "teaser": null
      },{
        "title": "This Week in RisingWave #4 (20230310)",
        "excerpt":"This blog series is my personal comments about (part of) the development of RisingWave. Please take it as an unofficial and no-promise supplement. Notable changes 🌟 Serial type feat(common): Add support for DataType::Serial RFC: add serial type remove the redundant exchange after append-only source executor As a distributed database system,...","categories": ["This-Week-in-RisingWave"],
        "tags": [],
        "url": "/this-week-in-risingwave/2023/03/10/twirw-4.html",
        "teaser": null
      },{
        "title": "This Week in RisingWave #5 (20230318)",
        "excerpt":"This blog series is my personal comments about (part of) the development of RisingWave. Please take it as an unofficial and no-promise supplement. Notable changes 🌟 Temporal join Tracking: Process time temporal join · Issue #8123 RFC: Temporal Join by chenzl25 #49 · risingwavelabs/rfcs Lots of production scenarios contain a...","categories": ["This-Week-in-RisingWave"],
        "tags": [],
        "url": "/this-week-in-risingwave/2023/03/18/twirw-5.html",
        "teaser": null
      },{
        "title": "This Week in RisingWave #6 (20230325)",
        "excerpt":"This blog series is my personal comments about (part of) the development of RisingWave. Please take it as an unofficial and no-promise supplement. Features Updates 🌟 NULLS {FIRST | LAST} feat(common): support NULLS {FIRST | LAST} by richardchien · Pull Request #8485 NULL s can be very tricky in SQL....","categories": ["This-Week-in-RisingWave"],
        "tags": [],
        "url": "/this-week-in-risingwave/2023/03/25/twirw-6.html",
        "teaser": null
      },{
